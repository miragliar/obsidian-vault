...
**Statistik:**
- Outlook-Mails (in 2'500 letzten): **28**
- Teams-Interaktionen: **102** (44 von Person, 58 meine 1:1-Antworten)
  - 1:1-Nachrichten: 40
  - Gruppen-Nachrichten: 4
- Letzter Teams-Kontakt: **2026-06-01**

**Gemeinsame Projekte / Gruppen-Chats:**
- **(ohne Titel)** (7 Nachrichten) — mit Pfister Remo, Giovanni Miraglia
- **(ohne Titel)** (0 Nachrichten) — mit Pfister Remo, Alessandro Castelli

**Wiederkehrende Begriffe / Themen** (aus Chat-Samples extrahiert):
- Raoul · MWST · Rechnung · MagazinApp · bitte · prüfen
<!-- /mail-summary -->
...
- [[50.work/m365-graph/setup-und-workflow]] — Quelle der Aggregation
- [[50.work/power-platform/_README]]