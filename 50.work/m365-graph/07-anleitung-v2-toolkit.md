...
tags: [resource, anleitung, codebase, m365, graph, obsidian, macos, windows, v2-toolkit]
related:
  - "[[06-mail-giovanni-v2-toolkit-juni-2026]]"
  - "[[08-distill-playbook-onenote]]"
  - "[[02-zugangsdaten-secrets]]"
---

> [!info] Adaption für Raouls Vault — Stand 2026-06-05
> Diese Anleitung wurde **für Michaels Vault** geschrieben. Bei Raoul abweichende Stellen:
>
> | Anleitung sagt | Bei Raoul ist es |
> |---|---|
> | Scripts-Ordner `<Vault>/40_Resources/scripts/` | `50.work/m365-graph/scripts/` |
> | Personen-Ordner `25_People/` | `50.work/25_People/` ✓ (Pfad-Auto-Detect über `SCRIPT_DIR.parent.parent` greift) |
> | Kunden-Ordner `20_Clients/` | `50.work/26_Firmen/` — **Pfad-Mapping nötig** für Phase-3-Skripte (`fill_stakeholders.py`, `apply_firmenprofile.py`, `link_people_to_clients.py`) |
> | Wochen-Report-Ziel `00_Inbox/M365 Wochen-Report.md` | (nicht vorhanden) — alternativ in `60.daily/` oder eigenen Inbox-Ordner |
> | App-Registrierung (TEIL 1) | **Schon erledigt** — Raoul nutzt Giovannis App. CLIENT_ID `0c8e309d-…`, TENANT_ID `ae7f72de-…` siehe [[02-zugangsdaten-secrets]] |
> | Token-Cache `.token_cache.bin` | **macOS Keychain** (`MiragliaBI-M365` / `graph-token-cache`) — Migration am 2026-06-05 erledigt; alte Datei umbenannt zu `.token_cache.bin.legacy` |
>
> **Phase-Stand:** Phase 1 (Auth) ✓ · Phase 2 (8 strukturneutrale Skripte) ✓ · Phase 3 (struktur-abhängig) offen — siehe [[06-mail-giovanni-v2-toolkit-juni-2026]].
