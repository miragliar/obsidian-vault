...
# Pfade per Env-Var anpassbar — Defaults entsprechen Michaels PARA-Layout.
# Bei Raoul z.B. CLIENTS_DIR=26_Firmen, INBOX_DIR=50.work/m365-graph/_inbox (siehe scripts/.env).
PEOPLE = ROOT / os.environ.get("PEOPLE_DIR", "25_People")
CLIENTS = ROOT / os.environ.get("CLIENTS_DIR", "20_Clients")
INBOX = ROOT / os.environ.get("INBOX_DIR", "00_Inbox")
